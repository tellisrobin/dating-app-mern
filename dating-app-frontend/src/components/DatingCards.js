        ...
        {people.map((person) => (
          ...
          >
            <div
              ...
              className="relative bg-[white] w-[400px] max-w-[85vw] h-[80vh] shadow-[0px_18px_53px_0px_rgba(0,0,0,0.3)] bg-cover bg-center p-5 rounded-[20px] text-[white] m-2.5 bottom-0"
            >
              <h3 className="absolute m-2.5 bottom-0 text-white">
                {person.name}
              </h3>
            </div>
          </DatingCard>
